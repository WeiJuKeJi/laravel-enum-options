...
```bash
GET /api/v1/enums/all                    # Get all enum options (recommended)
GET /api/v1/enums/payment-methods        # Payment methods
GET /api/v1/enums/payment-statuses       # Payment statuses
GET /api/v1/enums/refund-statuses        # Refund statuses
GET /api/v1/enums/order-statuses         # Order statuses
GET /api/v1/enums/order-types            # Order types
GET /api/v1/enums/user-statuses          # User statuses
GET /api/v1/enums/genders                # Genders
GET /api/v1/enums/approval-statuses      # Approval statuses
GET /api/v1/enums/publish-statuses       # Publish statuses
```
